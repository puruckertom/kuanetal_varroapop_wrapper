...
for (i in 1:Nsims) {
  ...
  vpdir_command <- paste(vpdir_exe, "VarroaPop_3_2_5_8.exe ", vpdir_exe, vrp_filename, 
...
for (i in 1:Nsims) {
  ...
  vpdir_command <- paste(vpdir_exe, "VarroaPop_3_2_5_8.exe ", vpdir_exe, "comparison.vrp", 
