...
for (i in 1:Nsims) {
  ...
  write(varroainput22, file = paste(vpdir_in_exp, "input",i,".txt", sep = ""), append = TRUE, sep = "\n")
  varroainput23 <- paste(parameter23, inputvalue23, sep=" ")
  write(varroainput23, file = paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput24 <- paste(parameter24, inputvalue24, sep=" ")
  write(varroainput24, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput25 <- paste(parameter25, inputvalue25, sep= " ")
  write(varroainput25, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput26 <- paste(parameter26, inputvalue26, sep= " ")
  write(varroainput26, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput27 <- paste(parameter27, inputvalue27, sep= " ")
  write(varroainput27, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput28 <- paste(parameter28, inputvalue28, sep= " ")
  write(varroainput28, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput29 <- paste(parameter29, inputvalue29, sep= " ")
  write(varroainput29, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput30 <- paste(parameter30, inputvalue30, sep= " ")
  write(varroainput30, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput31 <- paste(parameter31, inputvalue31, sep= " ")
  write(varroainput31, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput32 <- paste(parameter32, inputvalue32, sep= " ")
  write(varroainput32, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput33 <- paste(parameter33, inputvalue33, sep= " ")
  write(varroainput33, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput34 <- paste(parameter34, inputvalue34, sep= " ")
  write(varroainput34, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput35 <- paste(parameter35, inputvalue35, sep= " ")
  write(varroainput35, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput36 <- paste(parameter36, inputvalue36, sep= " ")
  write(varroainput36, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput37 <- paste(parameter37, inputvalue37, sep= " ")
  write(varroainput37, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput38 <- paste(parameter38, inputvalue38, sep= " ")
  write(varroainput38, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput39 <- paste(parameter39, inputvalue39, sep= " ")
  write(varroainput39, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
  varroainput40 <- paste(parameter40, inputvalue40, sep= " ")
  write(varroainput40, file= paste(vpdir_in_exp, "input", i, ".txt", sep=""), append= TRUE, sep = "\n")
