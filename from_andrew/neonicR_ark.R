...
adLD50<- runif(1000, 0, .5) #AIAdultLD50 (ug/bee)
...
for (i in 1:95) {
  n<-inputtest[i]
  inputfile<- paste("input",n,".txt", sep="")
  outputfile<- paste("results",n,".txt", sep="")
  logfile<- paste("log",n,".txt", sep="")
...
for (i in 1:1000) {
  ...
  #365 * 5 + 2 = 5 years + leap days
}
save(tdarray, file = paste(vpdir_output,"tdarray.RData", sep = ""))
load("C:\\Users\\AKanarek\\Documents\\BeePop\\DERs\\Rwrapper\\output\\tdarray.RData")
