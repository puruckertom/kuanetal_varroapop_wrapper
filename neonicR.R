...
par(mfrow=c(5,5), mar=c(0.5,1.5,1.5,0.5), oma=c(4,4,2.5,4))

plot(time[1:366], cp[1:366], type="l", ylab= "Colony Persistence", main= "1999", ylim=c(0,1))
plot(time[367:732], cp[367:732], type="l", main= "2000", ylim=c(0,1))
plot(time[733:1097], cp[733:1097], type="l", main= "2001", ylim=c(0,1))
plot(time[1098:1462], cp[1098:1462], type="l", main= "2002", ylim=c(0,1))
plot(time[1463:1827], cp[1463:1827], type="l", main= "2003", ylim=c(0,1))

plot(time[1:366], fa[1:366], type="l", ylab= "Foragers", ylim=c(0,1)) 
plot(time[367:732], fa[367:732], type="l", ylim=c(0,1))
plot(time[733:1097], fa[733:1097], type="l", ylim=c(0,1))
plot(time[1098:1462], fa[1098:1462], type="l", ylim=c(0,1))
plot(time[1463:1827], fa[1463:1827], type="l", ylim=c(0,1))

plot(time[1:366], aw[1:366], type="l", ylab= "Adult Workers", ylim=c(0,1)) 
plot(time[367:732], aw[367:732], type="l", ylim=c(0,1))
plot(time[733:1097], aw[733:1097], type="l", ylim=c(0,1))
plot(time[1098:1462], aw[1098:1462], type="l", ylim=c(0,1))
plot(time[1463:1827], aw[1463:1827], type="l", ylim=c(0,1))

plot(time[1:366], fm[1:366], type="l", ylab= "Free Mites", ylim=c(0,1)) 
plot(time[367:732], fm[367:732], type="l", ylim=c(0,1))
plot(time[733:1097], fm[733:1097], type="l", ylim=c(0,1))
plot(time[1098:1462], fm[1098:1462], type="l", ylim=c(0,1))
plot(time[1463:1827], fm[1463:1827], type="l", ylim=c(0,1))

plot(time[1:366], dfr[1:366], type="l", ylab= "Dead Foragers", ylim=c(0,1)) 
plot(time[367:732], dfr[367:732], type="l", ylim=c(0,1))
plot(time[733:1097], dfr[733:1097], type="l", ylim=c(0,1))
plot(time[1098:1462], dfr[1098:1462], type="l", ylim=c(0,1))
plot(time[1463:1827], dfr[1463:1827], type="l", ylim=c(0,1))
...
for (i in inputparam){
  ...
  par(mfrow=c(6,5), mar=c(0.5, 1.5, 1.5, 0.5), oma= c(4,4,2.5,7))

#COLONY SIZE
  plot(i, tdarray[122, 1, 1:1000], type="p", pch=20, main= "May 1999", ylab= "Colony Size", ylim=c(0,71000), xaxt='n')
  ...
  plot(i, tdarray[153, 1, 1:1000], type="p", pch=20, main= "June 1999", ylim=c(0,71000), xaxt='n')
  axis(1, labels=F, tick=T)
  ...
  plot(i, tdarray[183, 1, 1:1000], type="p", pch=20, main= "July 1999", ylim=c(0,71000), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick= T)
  ...
  plot(i, tdarray[214, 1, 1:1000], type="p", pch=20, main= "Aug 1999", ylim=c(0,71000), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick= T)
  ...
  plot(i, tdarray[245, 1, 1:1000], type="p", pch=20, main= "Sept 1999", ylim=c(0,71000), xaxt='n')
  axis(1, labels=F, tick=T)  
  axis(2, labels= F, tick= T)
...
#ADULT WORKERS
  plot(i, tdarray[122, 3, 1:1000], type="p", pch=20,  ylab="Adult Workers", ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  ...
  plot(i, tdarray[153, 3, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[183, 3, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[214, 3, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[245, 3, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
...
#FORAGERS
  plot(i, tdarray[122, 4, 1:1000], type="p", pch=20, ylab= "Foragers", ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  ...
  plot(i, tdarray[153, 4, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[183, 4, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[214, 4, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[245, 4, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)  
  axis(2, labels=F, tick=T)
...
#WORKER EGGS
  plot(i, tdarray[122, 10, 1:1000], type="p", pch=20, ylab="Worker Eggs", ylim=c(0,8000), xaxt='n')
  axis(1, labels=F, tick=T)
  ...
  plot(i, tdarray[153, 10, 1:1000], type="p", pch=20, ylim=c(0,8000), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[183, 10, 1:1000], type="p", pch=20, ylim=c(0,8000), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[214, 10, 1:1000], type="p", pch=20, ylim=c(0,8000), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[245, 10, 1:1000], type="p", pch=20, ylim=c(0,8000), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
...
#COLONY POLLEN
  plot(i, tdarray[122, 18, 1:1000], type="p", pch=20, ylab= "Colony Pollen (g)", ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  ...
  plot(i, tdarray[153, 18, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[183, 18, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[214, 18, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[245, 18, 1:1000], type="p", pch=20, ylim=c(0,5), xaxt='n')
  axis(1, labels=F, tick=T)
  axis(2, labels=F, tick=T)
...
#COLONY NECTAR
  ...
  plot(i, tdarray[153, 20, 1:1000], type="p", pch=20, ylim=c(0,30000))
  axis(1, labels=F, tick=T)  
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[183, 20, 1:1000], type="p", pch=20, ylim=c(0,30000))
  axis(1, labels=F, tick=T)  
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[214, 20, 1:1000], type="p", pch=20, ylim=c(0,30000))
  axis(1, labels=F, tick=T)  
  axis(2, labels=F, tick=T)
  ...
  plot(i, tdarray[245, 20, 1:1000], type="p", pch=20, ylim=c(0,30000))
  axis(1, labels=F, tick=T)  
  axis(2, labels=F, tick=T)
...
par(mfrow=c(1,1), oma= c(3,4,0,4), new= TRUE, xpd=NA)
plot(0:1,0:1, type="n", xlab=" ", ylab=" ", axes=FALSE)
title(main = for (i in 1:5) {paste(inputnames[i])}, outer = T)
legend("right",inset=c(-0.15,0), xpd=NA, legend=c("qs1", "qs2", "qs3", "qs4", "qs5"), fill=c(1:5),
         title= "Queen Strength", cex=0.75, bty="n")
