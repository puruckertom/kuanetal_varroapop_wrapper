...
write.table(srctdarray, file = paste(vpdir_output, "srctdarray_year.csv", sep=""))
write.table(pcctdarray, file = paste(vpdir_output, "pcctdarray_year.csv", sep=""))
