...
#inputdata_control11 <- subset(inputdf, select = -c(foliarenable, seedenable, soilenable, apprate))
...
inputdata_control11<- data.frame(queenstrength,wkrdrnratio, drnmitesurvive, wkrmitesurvive, fgrlifespan, miteimmtype) 
...
write.csv(inputdata_control11, file = paste(vpdir_in_control11, "inputdata_control11.csv", sep = ""))
